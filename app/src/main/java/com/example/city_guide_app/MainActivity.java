            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        startActivity(new Intent(new Intent(MainActivity.this, Willis.class)));
                        break;
                    case 3:
                        startActivity(new Intent(new Intent(MainActivity.this, Bean.class)));
                        break;
                    case 4:
                        startActivity(new Intent(new Intent(MainActivity.this, Water.class)));
                        break;
